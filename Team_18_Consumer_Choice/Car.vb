Public Class Car
    Public Shared Property CarList As New List(Of Car) 'Team 18 creates a shared list of Login objects
    ...
    Public Property Cost As Double 'Team 18 the name of the user that is asoociated with a specific instance of the Handling class
